-- Fix for update_invoice_with_items casting customer_id and purchase_order_id to UUID when they are actually BIGINT.
...
BEGIN
    ...
    SET 
        ...
        purchase_order_id = (p_invoice_data->>'purchase_order_id')::BIGINT,
