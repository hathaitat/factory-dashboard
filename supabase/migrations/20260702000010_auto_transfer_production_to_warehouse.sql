-- =========================================================================
-- Phase 3: Auto Transfer Production to Warehouse
-- Update batch_upsert_production_logs to auto-increment destination warehouse
-- =========================================================================
...
BEGIN
    ...
    LOOP
        ...
        IF (log_rec.value->>'id') IS NOT NULL AND (log_rec.value->>'id') != '' THEN
            ...
            FROM public.production_daily_logs WHERE id = (log_rec.value->>'id')::UUID;
