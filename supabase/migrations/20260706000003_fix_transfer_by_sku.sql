-- =========================================================================
-- Fix: Auto Transfer should match by SKU first, then fallback to product_name
-- =========================================================================
...
BEGIN
    ...
    LOOP
        ...
        IF v_target_wh IS NOT NULL AND v_delta != 0 THEN
            ...
            -- ✅ Step 1: Try to match by SKU (product_code) first — most reliable
            ...
            IF v_existing_inv_id IS NOT NULL THEN
                -- Update existing row (matched by SKU or name)
